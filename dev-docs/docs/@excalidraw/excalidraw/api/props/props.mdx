...
| --- | --- | --- | --- |
| [`initialData`](/docs/@mainsquare/excalidraw/api/props/initialdata) | `object` &#124; `null` &#124; <code>Promise<object &#124; null></code> | `null` | The initial data with which app loads. |
| [`excalidrawAPI`](/docs/@mainsquare/excalidraw/api/props/excalidraw-api) | `function` | \_ | Callback triggered with the excalidraw api once rendered |
...
| [`renderTopRightUI`](/docs/@mainsquare/excalidraw/api/props/render-props#rendertoprightui) | `function` | \_ | Render function that renders custom UI in top right corner |
| [`renderCustomStats`](/docs/@mainsquare/excalidraw/api/props/render-props#rendercustomstats) | `function` | \_ | Render function that can be used to render custom stats on the stats dialog. |
...
| [`UIOptions`](/docs/@mainsquare/excalidraw/api/props/ui-options) | `object` | [DEFAULT UI OPTIONS](https://github.com/excalidraw/excalidraw/blob/master/packages/excalidraw/constants.ts#L151) | To customise UI options. Currently we support customising [`canvas actions`](/docs/@mainsquare/excalidraw/api/props/ui-options#canvasactions) |
...
| [`renderEmbeddable`](/docs/@mainsquare/excalidraw/api/props/render-props#renderEmbeddable) | `function` | \_ | Render function that can override the built-in `<iframe>` |
...
You can add `customData` to elements when passing them as [`initialData`](/docs/@mainsquare/excalidraw/api/props/initialdata), or using [`updateScene`](/docs/@mainsquare/excalidraw/api/props/excalidraw-api#updatescene) / [`updateLibrary`](/docs/@mainsquare/excalidraw/api/props/excalidraw-api#updatelibrary) afterwards.
...
You can use [`THEME`](/docs/@mainsquare/excalidraw/api/utils#theme) to specify the theme.
