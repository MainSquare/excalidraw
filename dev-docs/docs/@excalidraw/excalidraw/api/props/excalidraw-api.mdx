...
This API is especially useful when you render a custom [`<Sidebar/>`](/docs/@mainsquare/excalidraw/api/children-components/sidebar), and you want to toggle it from your app based on a user action.
...
Subscribes to change events, similar to [`props.onChange`](/docs/@mainsquare/excalidraw/api/props#onchange).
