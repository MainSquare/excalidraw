...
| `toggleTheme` | `boolean` &#124; `null` | `null` | Indicates whether to show `Theme toggle`. When defined as `boolean`, takes precedence over [`props.theme`](/docs/@mainsquare/excalidraw/api/props#theme) to show `Theme toggle`. |
