...
import { KEYS, arrayToMap, getLineHeight } from "@mainsquare/excalidraw-common";

import { getElementBounds } from "@mainsquare/excalidraw-element";
...
vi.mock("@mainsquare/excalidraw-common", async (importOriginal) => {
