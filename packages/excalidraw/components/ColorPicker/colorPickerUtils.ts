import { MAX_CUSTOM_COLORS_USED_IN_CANVAS } from "@mainsquare/excalidraw-common";

import type { ExcalidrawElement } from "@mainsquare/excalidraw-element/types";

import type { ColorPickerColor, ColorPaletteCustom } from "@mainsquare/excalidraw-common";
