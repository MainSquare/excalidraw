...
import * as mockedSceneExportUtils from "@mainsquare/excalidraw/scene/export";
import { diagramFactory } from "@mainsquare/excalidraw/tests/fixtures/diagramFixture";
