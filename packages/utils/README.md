# @mainsquare/excalidraw-utils

## Install

```bash
npm install @mainsquare/excalidraw-utils
```

If you prefer Yarn over npm, use this command to install the Excalidraw utils package:

```bash
yarn add @mainsquare/excalidraw-utils
```
...
```js
import { exportToSvg, exportToBlob } from "@mainsquare/excalidraw-utils";
```

To use it in a browser directly:

```html
<script src="https://unpkg.com/@mainsquare/excalidraw-utils@0.1.0/dist/excalidraw-utils.min.js"></script>
<script>
